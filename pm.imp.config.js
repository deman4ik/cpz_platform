  ...
  apps: [
    {
      ...
      args:
        "--env --config prod.config.js --instances=3 dist/services/db/candles dist/services/db/db-importers dist/services/db/db-markets dist/services/db/user/db-users dist/services/db/robot",
      env: {
        NODE_ENV: "production",
        NODEID: "db"
      }
