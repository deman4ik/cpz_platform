module.exports = {
  apps: [
    ...
    },
    {
      ...
      script: "./node_modules/moleculer/bin/moleculer-runner.js",
      args:
        "--env --config prod.config.js dist/services/api.service.js dist/services/auth.service.js dist/services/exwatcher/exwatcher-runner.service.js dist/services/importer/importer-runner.service.js dist/services/backtester/backtester-runner.service.js dist/services/statsCalc/stats-calc-runner.service.js",
      env: {
        NODE_ENV: "production",
        NODEID: "api"
      }
