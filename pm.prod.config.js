module.exports = {
  apps: [
    ...
    },
    {
      ...
      script: "./node_modules/moleculer/bin/moleculer-runner.js",
      args:
        "--env --config prod.config.js dist/services/db/candles dist/services/db/db-exwatchers.service.js dist/services/exwatcher/binance-futures-watcher.service.js",
      env: {
        NODE_ENV: "production",
    ...
    },
    {
      ...
      script: "./node_modules/moleculer/bin/moleculer-runner.js",
      args:
        "--env --config prod.config.js dist/services/db/candles dist/services/db/db-exwatchers.service.js dist/services/exwatcher/bitfinex-watcher.service.js",
      env: {
        NODE_ENV: "production",
    ...
    },
    {
      ...
      script: "./node_modules/moleculer/bin/moleculer-runner.js",
      args:
        "--env --config prod.config.js dist/services/db/candles dist/services/db/db-exwatchers.service.js dist/services/exwatcher/kraken-watcher.service.js",
      env: {
        NODE_ENV: "production",
