  ...
  apps: [
    {
      ...
      args: "--env --config docker.config.js --instances=6 dist/services/db",
      env: {
        NODE_ENV: "production",
        NODEID: "db"
      }
    },
    {
      ...
      script: "./node_modules/moleculer/bin/moleculer-runner.js",
      args:
        "--env --config docker.config.js dist/services/backtester/backtester-runner.service.js",
      env: {
        NODE_ENV: "production",
    ...
    },
    {
      ...
      script: "./node_modules/moleculer/bin/moleculer-runner.js",
      args:
        "--env --config docker.config.js dist/services/connector/private-connector-runner.service.js",
      env: {
        NODE_ENV: "production",
    ...
    },
    {
      ...
      script: "./node_modules/moleculer/bin/moleculer-runner.js",
      args:
        "--env --config docker.config.js dist/services/exwatcher/exwatcher-runner.service.js",
      env: {
        NODE_ENV: "production",
    ...
    },
    {
      ...
      script: "./node_modules/moleculer/bin/moleculer-runner.js",
      args:
        "--env --config docker.config.js dist/services/exwatcher/binance-futures-watcher.service.js",
      env: {
        NODE_ENV: "production",
    ...
    },
    {
      ...
      script: "./node_modules/moleculer/bin/moleculer-runner.js",
      args:
        "--env --config docker.config.js dist/services/exwatcher/bitfinex-watcher.service.js",
      env: {
        NODE_ENV: "production",
    ...
    },
    {
      ...
      script: "./node_modules/moleculer/bin/moleculer-runner.js",
      args:
        "--env --config docker.config.js dist/services/exwatcher/kraken-watcher.service.js",
      env: {
        NODE_ENV: "production",
    ...
    },
    {
      ...
      script: "./node_modules/moleculer/bin/moleculer-runner.js",
      args:
        "--env --config docker.config.js dist/services/importer/importer-runner.service.js",
      env: {
        NODE_ENV: "production",
    ...
    },
    {
      ...
      script: "./node_modules/moleculer/bin/moleculer-runner.js",
      args:
        "--env --config docker.config.js dist/services/robot/robot-runner.service.js",
      env: {
        NODE_ENV: "production",
        NODEID: "robot-runner"
      }
    ...
    },
    {
      ...
      script: "./node_modules/moleculer/bin/moleculer-runner.js",
      args:
        "--env --config docker.config.js dist/services/userRobot/user-robot-runner.service.js",
      env: {
        NODE_ENV: "production",
    ...
    },
    {
      ...
      script: "./node_modules/moleculer/bin/moleculer-runner.js",
      args:
        "--env --config docker.config.js dist/services/statsCalc/stats-calc-runner.service.js",
      env: {
        NODE_ENV: "production",
