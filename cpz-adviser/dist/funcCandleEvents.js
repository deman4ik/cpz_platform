...
/******/ 	return hotCreateRequire("./src/funcs/funcCandleEvents.js")(__webpack_require__.s = "./src/funcs/funcCandleEvents.js");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var cpzEventTypes__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! cpzEventTypes */ "../cpz-shared/config/eventTypes/index.js");
/* harmony import */ var _adviser_handleEvents__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../adviser/handleEvents */ "./src/adviser/handleEvents.js");
...
function eventHandler(context, req) {
  ...
  parsedReq.forEach(function (eventGridEvent) {
    ...
    switch (eventGridEvent.eventType) {
      case cpzEventTypes__WEBPACK_IMPORTED_MODULE_0__["SUB_VALIDATION_EVENT"].eventType:
        {
      ...
      case cpzEventTypes__WEBPACK_IMPORTED_MODULE_0__["CANDLES_NEWCANDLE_EVENT"].eventType:
        {
          context.log.info("Got ".concat(eventGridEvent.eventType, " event data ").concat(JSON.stringify(eventData)));
          Object(_adviser_handleEvents__WEBPACK_IMPORTED_MODULE_1__["handleCandle"])(context, {
