...
function getSignalsListMenu(
  robots: { id: string; name: string; susbcribed: boolean }[]
) {
...
async function mySignalsEnter(ctx: any) {
  try {
    this.logger.info("mySignalsEnter");
    let myRobots;
