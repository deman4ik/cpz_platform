...
comment on column trades.order_num is 'order number from Exchange';
comment on column trades.exec_quantity is 'volume of asset in the order';

comment on table positions is 'Orders for position';